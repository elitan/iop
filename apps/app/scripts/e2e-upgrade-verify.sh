...
echo ''
echo '--- update log (docker related) ---'
grep -i -E '(docker|restart|network|pool|daemon)' /opt/frost/data/.update-log 2>/dev/null || echo '(no docker-related lines in update log)'
echo ''
